...
- **16 storefront modules** live (see [Modules.md](Modules.md); Side Cart shipped 1.55.0, default OFF). Suite tests green on php@8.3.
...
Side Cart shipped 1.55.0 (2026-07-22, default OFF) — **Checkout is now the lead unbuilt module**.

~~Side Cart~~ (**1.55.0**) · Checkout · Product Reviews · Product Badges · Flash Sale Banner ·
...
- **Revenue:** Side Cart shipped 1.55.0 (default OFF); **Checkout** is next — the buy-path surfaces
  ShopOS doesn't own today and where conversion is actually won.
