...
- VariationSwatches: removed the retired WooCommerce → Settings → Products → "Shop swatches" section (it only showed a "settings have moved" notice). Settings live under Freeman → Variation Swatches; no data affected.
