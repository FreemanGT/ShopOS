	...
	public function register_assets(): void {
		...
		wp_localize_script( 'etucart-vs-shop', 'EtucartShopVS', [
			...
			'i18n'               => [
				...
				'selectOpts'   => \Freeman\Core\Modules\VariationSwatches\Labels::get( 'select_options' ),
				'showMore'     => '+%d',
				'showLess'     => '−',
				'fromPrice'    => \Freeman\Core\Modules\VariationSwatches\Labels::get( 'from_price' ),
				'oos'          => \Freeman\Core\Modules\VariationSwatches\Labels::get( 'out_of_stock' ),
				'unavailable'  => \Freeman\Core\Modules\VariationSwatches\Labels::get( 'unavailable' ),
				'errorGeneric' => \Freeman\Core\Modules\VariationSwatches\Labels::get( 'error_generic' ),
				// Toast (1.6.4) — aria labels.
				'close'        => \Freeman\Core\Modules\VariationSwatches\Labels::get( 'close' ),
				'notices'      => \Freeman\Core\Modules\VariationSwatches\Labels::get( 'notices' ),
			],
		] );
