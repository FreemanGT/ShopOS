 ...
 *
 * Theme override: freeman/quick_view/drawer-content.php
 *
	...
	<div class="fc-quick-view__media">
		<?php if ( count( $gallery_ids ) >= 2 ) : ?>
			...
			<div class="fc-card-slider" data-fc-card-slider>
				...
				<button type="button" class="fc-card-slider__arrow fc-card-slider__arrow--prev" data-fc-slider-prev aria-label="<?php echo esc_attr__( 'Previous image', 'freeman-core' ); ?>">
				...
				<button type="button" class="fc-card-slider__arrow fc-card-slider__arrow--next" data-fc-slider-next aria-label="<?php echo esc_attr__( 'Next image', 'freeman-core' ); ?>">
