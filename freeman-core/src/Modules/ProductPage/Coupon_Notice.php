...
final class Coupon_Notice {
	...
	const HANDLE = 'freeman-core-pp-coupon';
	...
	public function notice_for_product( $product ) {
		 ...
		 */
		if ( ! apply_filters( 'freeman_core/product_page/show_coupon_notice', true, $product ) ) {
			return '';
		}
		 ...
		 * @param \WC_Product $product Current product.
		 */
		return apply_filters( 'freeman_core/product_page/coupon_notice_html', $html, $product );
	}
