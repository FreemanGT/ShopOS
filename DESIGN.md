...
# Design System: Freeman

## 1. Overview

**Creative North Star: "The Quiet Boutique"**

Freeman dresses a WooCommerce storefront the way a considered boutique dresses its
...
### Do:
- **Do** consume `--fm-*` tokens. Change a value in `freeman-tokens.css` and let it
