 ...
 * the standard WC loop and the ShopOS ProductSlider grid both render through
 ...
 *
 * Activation is a single control: enable the module (ShopOS → Modules) and
...
final class Module extends Module_Base {
	...
	public function label() {
		return __( 'Card Image Effects', 'shopos-core' );
	}
	...
	public function description() {
		return __( 'Enhances the product image on shop / archive cards: hover cross-fade to the second image, or a small swipeable slider of all images. Pick the behaviour with the Card image mode setting.', 'shopos-core' );
	}
	...
	public function settings_schema() {
		return array(
			'card_image_mode' => array(
				'label'       => __( 'Card image mode', 'shopos-core' ),
				'type'        => 'select',
				'choices'     => array(
					'none'           => __( 'None — leave the card image alone', 'shopos-core' ),
					'hover_swap'     => __( 'Hover swap — fade to the second image on hover', 'shopos-core' ),
					'gallery_slider' => __( 'Gallery slider — swipeable slider of all images', 'shopos-core' ),
				),
				'default'     => 'none',
				'description' => __( 'What happens to the product image on shop / archive cards.', 'shopos-core' ),
			),
			'slider_arrows'   => array(
				'label'          => __( 'Slider arrows', 'shopos-core' ),
				'type'           => 'checkbox',
				'checkbox_label' => __( 'Show prev / next arrows (fade in on hover)', 'shopos-core' ),
				'description'    => __( 'Gallery slider mode only. Turn off for a cleaner, swipe-only look.', 'shopos-core' ),
				'default'        => 1,
			),
		);
	}
	 ...
	 * being enabled (ShopOS → Modules) is the on/off; the mode defaults to
