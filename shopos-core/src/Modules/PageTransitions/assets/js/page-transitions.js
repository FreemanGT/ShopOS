/**
 * ShopOS Page Transitions — loading-overlay controller (layer A).
 *
 ...
 *   - product-search form submits ([shopos_search] palette + native forms)
 *   - `window.ShopOSPageTransitions.show()` — called by ShopFilters'
...
(function () {
    ...
    window.ShopOSPageTransitions = { show: show, hide: hide };
})();
