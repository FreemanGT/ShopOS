...
<fieldset class="shopos-sf__facet shopos-sf__facet--color" data-shopos-sf-facet="<?php echo esc_attr( $sf_taxonomy ); ?>">
	...
	<ul class="shopos-sf__swatches">
		...
		foreach ( $sf_terms as $sf_term ) :
			...
			?>
			<li class="shopos-sf__swatch">
				<label class="shopos-sf__swatch-label<?php echo ! empty( $sf_term['selected'] ) ? ' is-selected' : ''; ?>" title="<?php echo esc_attr( $sf_text ); ?>">
					<input
						type="checkbox"
						class="shopos-sf__checkbox shopos-sf__swatch-input"
					...
					/>
					<?php if ( '' !== $sf_image ) : ?>
						<span class="shopos-sf__swatch-chip" style="background-image:url('<?php echo esc_url( $sf_image ); ?>')"></span>
					<?php elseif ( '' !== $sf_color ) : ?>
						<span class="shopos-sf__swatch-chip" style="background-color:<?php echo esc_attr( $sf_color ); ?>"></span>
					<?php else : ?>
						<span class="shopos-sf__swatch-chip shopos-sf__swatch-chip--text"><?php echo esc_html( $sf_label ); ?></span>
					<?php endif; ?>
