<?php
/**
 * Shop Filters shortcode — [shopos_shop_filters].
 *
...
final class Shortcode {
	...
	const TAG          = 'shopos_shop_filters';
	const SCRIPT_HANDLE = 'shopos-core-shop-filters';
	const STYLE_HANDLE  = 'shopos-core-shop-filters';
	...
	public function render( $atts = array() ) {
		 ...
		 */
		do_action( 'shopos_core/shop_filters/before_render', $context_id );
		 ...
		 * @param int $context_id Current product_cat term id (0 = shop).
		 */
		do_action( 'shopos_core/shop_filters/after_render', $context_id );
		 ...
		 * @param int    $context_id Current product_cat term id (0 = shop).
		 */
		return (string) apply_filters( 'shopos_core/shop_filters/panel_html', $html, $context_id );
	}
	...
	private function template_path( $template ) {
		return SHOPOS_CORE_PATH . 'src/Modules/ShopFilters/templates/' . ltrim( $template, '/' );
	}
}
