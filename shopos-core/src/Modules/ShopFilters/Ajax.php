 ...
 *
 * Action `shopos_core_shop_filters_query` (admin-AJAX per decision §5.5 — no
...
final class Ajax {
	...
	const ACTION = 'shopos_core_shop_filters_query';
	const NONCE  = 'shopos_core_shop_filters_query';
