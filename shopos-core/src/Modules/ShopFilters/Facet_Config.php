 ...
 * admin editing surface for the `shopos_core_shop_filters_facet_config` option
...
final class Facet_Config {
	...
	const OPTION = 'shopos_core_shop_filters_facet_config';
	...
	public static function resolve( array $available_taxonomies, $context_category_id = 0 ) {
		 ...
		 */
		$defs = apply_filters( 'shopos_core/shop_filters/facet_config', $defs, $context_category_id, $available_taxonomies );
		...
		foreach ( (array) $defs as $def ) {
			 ...
			 * @param int    $context_category_id Current category (0 = shop).
			 */
			$is_visible = (bool) apply_filters( 'shopos_core/shop_filters/is_facet_visible', $is_visible, (string) $def['taxonomy'], $context_category_id );
