...
final class Indexer {
	...
	const QUEUE_OPTION     = 'shopos_core_search_dirty_queue';
	const WATERMARK_OPTION = 'shopos_core_search_last_sweep_gmt';
	const LAST_RUN_OPTION  = 'shopos_core_search_last_run_gmt';
	const DRAIN_HOOK       = 'shopos_core_search_drain_queue';
	const RECONCILE_HOOK   = 'shopos_core_search_reconcile';
	const CRON_SCHEDULE    = 'shopos_search_5min';
	const AS_GROUP         = 'shopos-search';
	const BATCH_SIZE       = 50;
