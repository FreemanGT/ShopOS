...
final class Module extends Module_Base {
	...
	public function label() {
		return __( 'Category Slider', 'shopos-core' );
	}
	...
	public function description() {
		return __( 'Editorial Elementor widget for WooCommerce product categories — drag-scroll slider with momentum, hover ring, progress bar.', 'shopos-core' );
	}
