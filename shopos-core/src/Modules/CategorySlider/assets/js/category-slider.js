/*
 * ShopOS Category Slider — vanilla JS runtime.
 *
...
(function () {
	...
	if (window.jQuery) {
		window.jQuery(window).on('elementor/frontend/init', function () {
			...
			['shopos_category_slider.default', 'shopos_product_slider.default'].forEach(function (hook) {
	...
	window.ShopOSCategorySlider = { init: initAll };
})();
