...
### `shopos_core/product_slider/query_args` (filter, since 1.11.1)
```php
apply_filters(
...
### `shopos_core/product_slider/archive_thumbnail_size` (filter, since 1.21.40)
```php
apply_filters(
    'shopos_core/product_slider/archive_thumbnail_size',
...
`frontend/element_ready/shopos_product_slider.default`.
