...
use ShopOS\Core\Modules\ShopFilters\Database;
 ...
 *
 * @covers \ShopOS\Core\Modules\ShopFilters\Database
 */
final class ShopFiltersDatabaseTest extends TestCase {

	public function test_schema_sql_contains_columns_and_keys(): void {
		$sql = Database::schema_sql( 'wp_shopos_shop_filter_index', 'DEFAULT CHARSET=utf8mb4' );

		$this->assertStringContainsString( 'CREATE TABLE wp_shopos_shop_filter_index', $sql );
