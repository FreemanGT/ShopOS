...
// is_search gets its OWN global (not an fr_page_type value): the §11.4 row-5
// search carve-out needs "product archive AND search" simultaneously true
// (native product search is is_shop() + is_search() at once), which the
// single-valued fr_page_type cannot express. Defaults false.
