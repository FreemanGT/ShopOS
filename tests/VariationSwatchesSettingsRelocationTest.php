...
final class VariationSwatchesSettingsRelocationTest extends TestCase {
	...
	public function test_settings_schema_returns_seventeen_keys_with_no_flag_set(): void {
	...
	public function test_settings_schema_key_set_is_stable(): void {
		$expected = array(
			...
			'shop_excluded_categories', 'pdp_hide_oos', 'pdp_show_sticky_bar', 'pdp_show_buy_now',
			'shop_hide_oos', 'shop_no_preselect',
